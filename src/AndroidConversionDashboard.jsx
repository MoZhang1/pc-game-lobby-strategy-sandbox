...
const NEW_USER_EXPERIMENT_IDS = ['local-hot-v1', 'local-hot-v2', 'local-hot-observation', 'local-hot-waiting-package', 'local-package-prepublish-incident', 'local-package-official-launch', 'local-package-config-cities'];
