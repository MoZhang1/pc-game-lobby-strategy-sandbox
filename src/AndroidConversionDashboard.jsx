...
import { LATEST_LOCAL_PACKAGE_GEO_DATA, PREVIOUS_LOCAL_PACKAGE_GEO_DATA } from './localPackageLatestGeoData';
...
const CURRENT_LOCAL_PACKAGE_PERIOD = {
...
const daily = DAILY_ROWS.map(([date, users, ...uvs]) => ({
  ...
  uv: { [NEW_USER_POPUP.id]: NEW_USER_POPUP_UV[date] ?? null, ...Object.fromEntries(BASE_EVENTS.map((event, index) => [event.id, uvs[index]])), ...Object.fromEntries(PACKAGE_EVENTS.map(event => [event.id, packageByDate[date]?.[event.id] || 0])) },
}));
...
const TARGET_GAME_MONTHS = [{"label":"1月","pc":{"users":2026379,"game":21.656215347671882,"union":0.3522539465716927,"total":21.921220067914245},"android":{"users":6099110,"game":39.07594714638693,"union":0.15436678466202447,"total":39.1820609892263}},{"label":"2月","pc":{"users":1717630,"game":21.69710589591472,"union":0.44153863171928764,"total":22.026629716528006},"android":{"users":5452237,"game":39.762578185797864,"union":0.1734517410009873,"total":39.883152548210944}},{"label":"3月","pc":{"users":2299598,"game":21.733755204170468,"union":0.6866852380285597,"total":22.245192420588296},"android":{"users":6243566,"game":39.04440186906009,"union":0.15012254214979068,"total":39.146234699849416}},{"label":"4月","pc":{"users":2311613,"game":21.667727253653617,"union":0.661702456250246,"total":22.1598078917189},"android":{"users":5967970,"game":39.57469625349994,"union":0.13240683180377916,"total":39.66531333099865}},{"label":"5月","pc":{"users":2425229,"game":21.46531317248804,"union":0.8381476553348157,"total":22.0965525317403},"android":{"users":5900496,"game":40.169267126017886,"union":0.17439211889983486,"total":40.28976547056383}},{"label":"6月","pc":{"users":2485239,"game":22.939202225620956,"union":0.3818948600114516,"total":23.225371885762293},"android":{"users":5628923,"game":40.79588582043137,"union":0.23126981840042934,"total":40.96499454691421}},{"label":"7月","pc":{"users":2649323,"game":25.318581388528315,"union":0.4206357624193049,"total":25.63243515418845},"android":{"users":5721197,"game":41.10753396535725,"union":0.17921074907925738,"total":41.23694744299139}},{"label":"8月","pc":{"users":2589036,"game":24.05918650802847,"union":0.22046815880505333,"total":24.223069899375673},"android":{"users":5651471,"game":42.28994539651712,"union":0.2048670160388331,"total":42.43976479751909}},{"label":"9月*","pc":{"users":707986,"game":24.065588867576476,"union":0.18361945010212066,"total":24.200619786266962},"android":{"users":1433106,"game":42.508928160233786,"union":0.26187874448924225,"total":42.69907459741289}}];

const ACTIVE_EXPERIMENT_DAILY = [["2026-07-29",185376,77373,316,77588],["2026-07-30",186273,77629,358,77899],["2026-07-31",184865,77547,363,77817],["2026-08-01",182889,77129,463,77476],["2026-08-02",183223,76994,370,77261],["2026-08-03",182942,76661,346,76920],["2026-08-04",183827,76614,458,76936],["2026-08-05",184423,77673,444,78001],["2026-08-06",184409,77604,595,78033],["2026-08-07",183060,77234,590,77674],["2026-08-08",182584,77749,345,77981],["2026-08-09",184082,78461,547,78865],["2026-08-10",184537,78793,383,79078],["2026-08-11",184620,78528,409,78830],["2026-08-12",185143,78714,527,79093],["2026-08-13",183763,78514,390,78799],["2026-08-14",183076,77330,319,77561],["2026-08-15",181932,76998,241,77180],["2026-08-16",181964,77206,217,77352],["2026-08-17",180787,75562,250,75754],["2026-08-18",182224,77282,221,77449],["2026-08-19",182335,77738,244,77911],["2026-08-20",183817,78613,226,78785],["2026-08-21",182583,77419,310,77658],["2026-08-22",181520,77668,294,77896],["2026-08-23",181690,77362,317,77609],["2026-08-24",183396,78609,269,78805],["2026-08-25",181003,76234,297,76446],["2026-08-26",180351,75231,290,75429],["2026-08-27",181058,76247,316,76468],["2026-08-28",180588,76025,455,76352],["2026-08-29",177671,74896,461,75228],["2026-08-30",179853,76371,543,76761],["2026-08-31",176121,72545,441,72880],["2026-09-01",180150,76445,434,76752],["2026-09-02",180211,76191,589,76622],["2026-09-03",180812,76891,495,77235],["2026-09-04",179927,76703,600,77158],["2026-09-05",177742,75922,393,76192],["2026-09-06",177446,75827,559,76239],["2026-09-07",177696,74787,297,75003],["2026-09-08",179122,76432,386,76722]].map(item => Array.isArray(item) ? (() => { const [date, users, chess, union, total] = item; return { date, label: `${Number(date.slice(5, 7))}/${Number(date.slice(8))}`, users, chess: chess / users * 100, union: union / users * 100, total: total / users * 100 }; })() : item);
...
function GlobalEventTable() {
  const all = getSummary('2026-06-20', '2026-09-08');
  const packagePeriod = getSummary('2026-07-15', '2026-09-08');
  const popupPeriod = getSummary(NEW_USER_POPUP.start, '2026-09-08');
  return <div className="globalEventTable" role="table" aria-label="模块事件概览">
    ...
    {EVENTS.map(event => { const summary = event.id === NEW_USER_POPUP.id ? popupPeriod : PACKAGE_EVENTS.some(item => item.id === event.id) ? packagePeriod : all; const note = event.id === NEW_USER_POPUP.id ? '8/10新增；8/11起有记录（29天）' : PACKAGE_EVENTS.some(item => item.id === event.id) ? '7/15起' : '全期'; return <div className="globalEventRow" role="row" key={event.id}><strong role="cell" data-label="事件">{event.id === 'TOTAL_START' ? event.label : `${event.id} · ${event.label}`}</strong><span role="cell" data-label="全期占比">{formatRate(summary.stats[event.id].rate)}</span><span role="cell" data-label="数据说明">{note} {summary.stats[event.id].uv.toLocaleString()} / {summary.stats[event.id].users.toLocaleString()}</span></div>; })}
  </div>;
}

function GlobalDataPage({ embedded = false }) {
  const [range, setRange] = useState({ start: '2026-08-09', end: '2026-09-08' });
  ...
  return <>
    {!embedded && <header className="pageIntro"><div><h1>安卓新用户分发数据</h1><p>总启动与模块点击总览</p></div><span>数据更新至 2026/09/08</span></header>}
    <Card className="filterCard"><div className="filterCopy"><CalendarDays /><div><b>数据日期</b><span>模块数据有效起始 6/20；7/15 起本地包单列；8/10 新增新用户首屏弹窗</span></div></div><DateRangeInput label="数据日期" isLabelHidden value={range} onChange={value => value && setRange(value)} min="2026-06-20" max="2026-09-08" numberOfMonths={1} /><Button label="应用筛选" variant="primary" onClick={() => setAppliedRange(range)} /></Card>
    ...
    <div className="reviewCallout"><b>新增事件：新用户首屏弹窗</b><p>8/10 新增；源表 8/10 缺少记录，8/11–9/8 共 29 天有记录。趋势中未上线和缺少记录均留空，有记录的 0 正常展示；概览占比仅用有记录日期的点击 UV 合计 / 同期新增用户 UV 合计。该占比不是弹窗曝光后的点击率，各事件用户可重叠，不能相加作为总启动。</p></div>
    <div className="reviewCallout"><b>最新完整周：9/2–9/8</b><p>总启动 70.64% → 68.90%（-1.74pp）。9/7 为最新低点 66.22%；9/4 主要是非本地包同步走弱，9/7 则本地包配置点击也下降。完整诊断与10省实验结果见“实验复盘”，本周新增10省配置计划已补充。</p></div>
...
const PC_ACTIVE_EXPERIMENT_DAILY = [["2026-08-19",85718,21171],["2026-08-20",86834,21275],["2026-08-21",87123,21249],["2026-08-22",77569,18715],["2026-08-23",76799,18441],["2026-08-24",88125,21486],["2026-08-25",88179,21723],["2026-08-26",88363,21795],["2026-08-27",89510,22063],["2026-08-28",90275,21902],["2026-08-29",80026,19414],["2026-08-30",79155,19252],["2026-08-31",90127,21980],["2026-09-01",90953,21812],["2026-09-02",92219,22035],["2026-09-03",91452,22098],["2026-09-04",91763,22183],["2026-09-05",79382,19238],["2026-09-06",78607,19066],["2026-09-07",91914,22512],["2026-09-08",91696,22393]].map(([date, users, total]) => ({ date, label: `${Number(date.slice(5, 7))}/${Number(date.slice(8))}`, users, total: total / users * 100 }));
...
function AndroidActiveExperimentReview() {
  const [experimentId, setExperimentId] = useState('active-banner-september');
  ...
  return <section className="pageSection"><div className="sectionTitle"><div><h2>活跃用户定向分发实验复盘</h2><p>安卓活跃用户 · 按实际配置日展示实验前后数据</p></div></div>
    ...
    <section className="experimentBlock"><Card className="experimentBrief activeUserExperiment"><div><span>实验周期</span><b>{experiment.title} · {formatDate(experiment.start)}–{formatDate(experiment.end)}</b><small>实验前对比：{experiment.baseline}</small></div><div><span>实验模块</span><b>{experiment.id === 'active-banner-september' ? '首屏 Banner' : '本地热门'}</b></div><div><span>实验内容</span><b>{experiment.content}</b></div></Card>
    ...
    <div className="reviewCallout activeUserCallout"><b>本轮结论：{experiment.id === 'active-banner-september' ? '整体正向，素材因果待验证' : experiment.delta >= 0 ? '正向' : '轻微负向'}</b><p>{experiment.conclusion}</p></div>
    ...
    <section className="pageSection"><div className="sectionTitle"><div><h2>下一步</h2><p>{experiment.id === 'active-banner-september' ? '本周无新增实验，继续观察' : experiment.id === 'active-latest-observation' ? '后续动作按实际配置日记录' : '按周三开始，观察 7 天'}</p></div></div><ol className="reviewActions"><li><b>{experiment.next}</b></li></ol></section></section>
  </section>;
}

function PcActiveExperimentReview() {
  const [experimentId, setExperimentId] = useState('pc-latest-observation');
  ...
  return <section className="pageSection"><div className="sectionTitle"><div><h2>活跃用户定向分发实验复盘</h2><p>PC 活跃用户 · 每个实验区间统一展示前后两周数据</p></div></div>
    ...
    <section className="pageSection"><div className="sectionTitle"><div><h2>下一步</h2><p>本周计划提高本地热门营收游戏权重并增加联运游戏数量</p></div></div><ol className="reviewActions"><li><b>{experiment.next}</b></li></ol></section></section>
  </section>;
}
...
function TargetGamePage({ platform }) {
  ...
  const conclusion = isPc ? '9/1–9/8 变现率 24.20%，较 8 月 24.22% 低 0.02pp。最新完整周 24.36% → 24.23%（-0.13pp），首轮配置尚未表现出持续提升；本周计划提高本地热门营收游戏权重并增加联运游戏数量。' : '9/1–9/8 变现率 42.70%，较 8 月 42.44% 高 0.26pp。9/2–9/8 完整周提升 0.52pp；9/3 素材轮换后同星期六天对比提升 0.49pp。缺少活跃用户 Banner 点击明细，只能确认整体改善，不能单独归因为素材。';
  return <>
    <header className="pageIntro"><div><h1>{name}分发数据</h1><p>活跃用户进入营收游戏的月度表现</p></div><span>数据更新至 2026/09/08 · 9月*仅含1–8日</span></header>
    ...
    <section className="pageSection"><div className="sectionTitle"><div><h2>进入营收游戏趋势</h2><p>按月汇总：进入营收游戏 UV / 用户池 UV；9月*仅含1–8日，尚非完整月</p></div></div><Card className="chartCard"><TargetGameTrendChart platform={platform} /></Card></section>
...
const NEW_USER_EXPERIMENT_IDS = ['local-hot-v1', 'local-hot-v2', 'local-hot-observation', 'local-hot-waiting-package', 'local-package-prepublish-incident', 'local-package-official-launch', 'local-package-weekly-observation', 'local-package-config-cities', 'local-package-ten-provinces', 'total-start-dip-sep4'];
...
function LocalPackageGeoReview() {
  const geoPeriods = [...LOCAL_PACKAGE_GEO_PERIODS, LATEST_LOCAL_PACKAGE_PERIOD, CURRENT_LOCAL_PACKAGE_PERIOD];
  const [periodId, setPeriodId] = useState('2026-09-02_2026-09-08');
  ...
  const insightFor = item => {
    ...
    if (selectedPeriod.id === CURRENT_LOCAL_PACKAGE_PERIOD.id) {
  ...
  return <section className="localPackageGeoReview">
    ...
    {selectedPeriod.id === CURRENT_LOCAL_PACKAGE_PERIOD.id && <DistributionWeeklyDiagnosis geoOnly />}
...
function ReviewPage({ experimentIds = EXPERIMENTS.map(item => item.id), title = '实验复盘', subtitle = '按实验区间切换查看 · 7/15 起本地包点击单列展示', showPackageWeeks = false, embedded = false }) {
  ...
  if (experiment.isOngoing) return <>
    {!embedded && <header className="pageIntro"><div><h1>{title}</h1><p>{subtitle}</p></div><span>数据更新至 2026/09/08</span></header>}
  ...
  const nextSteps = experimentId === 'local-package-ten-provinces' ? [{ title: '本周新增10省配置', detail: NEXT_NEW_USER_PLAN }] : experimentId === 'total-start-dip-sep4'
  ...
  return <>
    ...
    <section className="experimentBlock"><div className="sectionTitle"><div><h2>{experiment.title}</h2><p>{formatDate(experiment.start)}–{formatDate(experiment.end)} · 对比 {formatDate(experiment.beforeStart)}–{formatDate(experiment.beforeEnd)}</p></div></div>
      ...
      {experimentId === 'local-package-ten-provinces' && <DistributionWeeklyDiagnosis />}
...
function AndroidNewUserPage() {
  ...
  return <><header className="pageIntro"><div><h1>安卓新用户分发数据</h1><p>纯新增用户的总启动、模块点击与实验复盘</p></div><span>全局数据至 2026/09/08 · 本地包分城市数据支持 8/17 起滚动观察</span></header>
