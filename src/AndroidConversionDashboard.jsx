...
import { LATEST_LOCAL_PACKAGE_GEO_DATA, PREVIOUS_LOCAL_PACKAGE_GEO_DATA, COMPARABLE_CURRENT_LOCAL_PACKAGE_GEO_DATA, COMPARABLE_PREVIOUS_LOCAL_PACKAGE_GEO_DATA } from './localPackageLatestGeoData';
...
const CURRENT_LOCAL_PACKAGE_PERIOD = { id: '2026-09-09_2026-09-15', label: '9/9–9/15（排除 9/12，共 6 天）', data: COMPARABLE_CURRENT_LOCAL_PACKAGE_GEO_DATA };
...
function LocalPackageGeoReview() {
  ...
  const comparisonData = isCurrent ? COMPARABLE_PREVIOUS_LOCAL_PACKAGE_GEO_DATA : PREVIOUS_LOCAL_PACKAGE_GEO_DATA;
