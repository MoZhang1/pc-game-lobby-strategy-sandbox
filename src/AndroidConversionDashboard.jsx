...
function ReviewPage() {
  return <>
    ...
    <section className="pageSection"><div className="sectionTitle"><div><h2>优化前后趋势</h2><p>仅保留优化前后各 7 天 · 虚线为 7 月 8 日本地热门优化上线</p></div></div><Card className="chartCard"><TrendChart items={daily.filter(item => item.date >= '2026-07-01' && item.date <= '2026-07-14')} eventIds={['60101404', '60100102']} annotate /></Card></section>
    ...
    <section className="pageSection"><div className="sectionTitle"><div><h2>下一步</h2></div></div><ol className="reviewActions"><li><b>下周优化本地热门的新用户游戏位。</b><span>减少 1 个营收游戏位，增加 1 个棋牌游戏位。</span></li><li><b>定位下降明显模块的原因。</b><span>优先拆解“游戏模块开始玩”下降 1.25pp：承接游戏、排序与点击后的启动链路。</span></li></ol></section>
  </>;
}
