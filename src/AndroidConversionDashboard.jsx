...
function GlobalDataPage({ embedded = false }) {
  ...
  return <>
    ...
    <div className="reviewCallout"><b>最新完整周：9/2–9/8</b><p>总启动 70.13% → 68.34%（-1.79pp）。9/7 为最新低点 65.32%；9/4 主要是非本地包同步走弱，9/7 则本地包配置点击也下降。完整诊断与10省实验结果见“实验复盘”，本周新增10省配置计划已补充。</p></div>
