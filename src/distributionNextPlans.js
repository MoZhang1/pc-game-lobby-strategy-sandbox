...
export const NEXT_NEW_USER_PLAN = '9/23–9/29 已确认待办：计划于 9/23（周三）更换本地包广告位推荐游戏，将“打大A、四副牌升级”更换为“五十K、双扣”。其余分析建议（待确认）：保留浙江、江苏、广东当前配置；核对广告位展示、分游戏点击和跳转，并观察换游戏后效果；广东先查广州、佛山页面到达，内蒙古、辽宁、安徽先按城市复核下降及样本。';
export const NEXT_ANDROID_ACTIVE_PLAN = '9/23–9/29 已确认待办：计划于 9/23（周三）取消新用户三日前与三日后的推荐策略分界；新用户由本地包页面兜底，第 2 日起直接进入活跃用户分发策略。';
